...
namespace TarodevController {
    public class PlayerInput : MonoBehaviour {
        ...
        private InGameUIController _inGameUI;

        private void Update() => FrameInput = Gather();

#if ENABLE_INPUT_SYSTEM
        private PlayerInputActions _actions;
        private InputAction _move, _jump, _dash, _attack, _save, _load;
        ...
        private void Awake() {
            ...
            _save = _actions.Player.Save;
            _load = _actions.Player.Load;

            _inGameUI = FindObjectOfType<InGameUIController>();
        }
        ...
        private FrameInput Gather() {
            ...
            return new FrameInput {
                ...
                SaveDown = _save.WasPressedThisFrame(),
